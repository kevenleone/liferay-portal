...
public class DDMStructureLayoutModelListener
	extends BaseModelListener<DDMStructureLayout> {

	@Override
	public void onAfterRemove(DDMStructureLayout ddmStructureLayout)
		throws ModelListenerException {

		List<AppBuilderApp> appBuilderApps =
			_appBuilderAppLocalService.getAppBuilderAppsByDDMStructureLayoutId(
