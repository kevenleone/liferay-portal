  ...
  return (
    <ClayInput.GroupItem>
      <ClayInput
        ...
        disabled={
          !search && questions && questions.items && !questions.items.length
        }
      ...
      <ClayInput.GroupInsetItem after className="bg-transparent" tag="span">
        {loading && (
          <button className="btn btn-monospaced btn-unstyled" type="submit">
