...
public abstract class BaseMarketplaceResourceImpl
	implements MarketplaceResource {

	/**
	 * Invoke this method with the command line:
	 *
	 * curl -X 'POST' 'http://localhost:8080/o/marketplace-admin/v1.0/connect'  -u 'test@liferay.com:test'
	 */
	@io.swagger.v3.oas.annotations.tags.Tags(
		value = {@io.swagger.v3.oas.annotations.tags.Tag(name = "Marketplace")}
	)
	@javax.ws.rs.Path("/connect")
	@javax.ws.rs.POST
	...
	private static final com.liferay.portal.kernel.log.Log _log =
		LogFactoryUtil.getLog(BaseMarketplaceResourceImpl.class);
